...
class Item(db.Model):
    ...
    created_at = db.Column(db.DateTime, nullable=False, default=datetime.now(pytz.timezone('Asia/Kolkata'))) # Added created_at column
    ...
    purchase_price = db.Column(db.Float, nullable=False) # Added updated_at column with onupdate=datetime.utcnow to update automatical
